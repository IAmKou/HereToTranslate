...
export class GroupManagerService extends ManagerServiceImpl {
  ...
  async createProjectGroup(uid: bigint, projectId: bigint, data: CreateProjectGroupDto) {
    await this.projectManager.testPermissions(projectId, uid, PermissionFlags.ManageGroups);
  ...
  async addUsersToGroup(uid: bigint, projectId: bigint, groupId: bigint, userIds: bigint[]) {
    await this.projectManager.testPermissions(projectId, uid, PermissionFlags.ManageMembers);
