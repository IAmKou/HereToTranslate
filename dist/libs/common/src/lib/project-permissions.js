...
exports.Permission = exports.ThreadPermissionsMask = exports.PermissionFlags = void 0;
/**
 * Bit flags representing project and workspace permissions.
 */
exports.PermissionFlags = Object.freeze({
...
exports.ThreadPermissionsMask = BigInt(exports.PermissionFlags.ManageComments |
    exports.PermissionFlags.PostComment |
    exports.PermissionFlags.Vote |
    exports.PermissionFlags.AttachFiles |
    exports.PermissionFlags.ViewThread);
/**
...
class Permission {
    ...
    resolveNames() {
        return Object.keys(exports.PermissionFlags)
            .filter(key => typeof exports.PermissionFlags[key] === 'bigint'
            && (this._value & exports.PermissionFlags[key]) === exports.PermissionFlags[key]);
    }
    [Symbol.toStringTag]() {
     ...
     */
    resolvePermission(perm) {
        if (perm instanceof Permission) {
            return perm.value;
        }
        else if (typeof perm === 'string') {
            if (perm in exports.PermissionFlags) {
                return exports.PermissionFlags[perm];
            }
            if (/\d+n?/.test(perm)) {
                return BigInt(perm);
            }
    ...
    static from(...permissions) {
        const perms = new Permission(exports.PermissionFlags.None);
    ...
    has(...permissions) {
        ...
        for (const perm of permissions) {
            ...
            if (resolvedPerm === exports.PermissionFlags.None)
                continue;
