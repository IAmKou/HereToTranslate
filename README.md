...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/xkXPP0e4sX)
...
```sh
npx nx serve HereToTranslate
```

To create a production bundle:

```sh
npx nx build HereToTranslate
```

To see all available targets to run for a project, run:

```sh
npx nx show project HereToTranslate
```
