...
// Preview and export state removed - now handled by dedicated page
...
// Preview và Export methods
function openPreviewExport(file: any) {
  // Navigate to preview page with file and language parameters
  router.push({
...
function exportFile(file: any) {
  // Navigate to preview page with file and language parameters for export
  router.push({
    name: 'translation-preview',
    params: {
      projectId: projectId.value,
...
// Preview and export methods removed - now handled by dedicated page
          ...
          <div v-for="file in filteredFiles" :key="file.fileId || file.id" class="file-accordion">
            <div class="file-header">
              ...
              <div class="file-header-actions">
                <button
                  @click.stop="openPreviewExport(file)"
                  class="action-btn preview-btn"
                  :disabled="isFileProcessing(file)"
                  :title="isFileProcessing(file) ? 'File is processing...' : 'Preview & Export'"
                >
                  <i class="pi pi-eye"></i>
                  <span>Preview</span>
                </button>
